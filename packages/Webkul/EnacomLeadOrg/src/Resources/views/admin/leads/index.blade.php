...
@section('content-wrapper')
  <div class="content">
    <div class="page-action">
      <form id="lead-filter-form" method="GET" action="{{ route('admin.leads.index') }}"
        ...
        <ul id="org-suggestions"
          style="position:absolute; background:#1e1e1e; border:1px solid #444; list-style:none; margin:0; padding:0; max-height:200px; overflow:auto; width:300px; display:none;">
        </ul>
    ...
    <table-component src="{{ route('admin.leads.enacom_grid') }}{{ $qs ? ('?' . $qs) : '' }}" :columns="[
                  { name: 'id', label: 'ID' },
